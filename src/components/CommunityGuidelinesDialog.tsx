      ...
      <DialogContent className="max-w-3xl h-[85vh] flex flex-col overflow-hidden">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold">
            {isSpanish ? 'Directrices de la Comunidad de Konfetti' : 'Konfetti Community Guidelines'}
          </DialogTitle>
        </DialogHeader>
...
function SpanishGuidelines() {
  return (
    <div className="space-y-6 text-sm leading-relaxed">
      ...
      <div>
        <h2 className="text-xl font-semibold mt-6 mb-3">Directrices de Perfil</h2>

        <h3 className="text-lg font-semibold mt-4 mb-2">Edad</h3>
        <p>
        ...
        <h3 className="text-lg font-semibold mt-4 mb-2">Fotos de Perfil</h3>
        <p>
        ...
        <h3 className="text-lg font-semibold mt-4 mb-2">Nombre e Información del Perfil</h3>
        <p>
      ...
      <div>
        <h2 className="text-xl font-semibold mt-6 mb-3">Directrices de Contenido y Conducta</h2>

        <h3 className="text-lg font-semibold mt-4 mb-2">Desnudez Adulta y Actividad Sexual</h3>
        <p>
        ...
        <h3 className="text-lg font-semibold mt-4 mb-2">Acoso y Conducta Abusiva</h3>
        <p>
        ...
        <h3 className="text-lg font-semibold mt-4 mb-2">Seguridad Infantil</h3>
        <p>
          Tenemos tolerancia cero para contenido que sexualice o dañe a menores. Esto incluye cualquier imagen, dibujo o discusión que represente a menores en un contexto sexual, incluso para crear conciencia. Cualquier reporte de explotación infantil resultará en suspensión inmediata y puede ser referido a las autoridades.
        </p>

        <h3 className="text-lg font-semibold mt-4 mb-2">Actividad Comercial y Promocional</h3>
        <p>
          Konfetti no es un mercado ni una plataforma de publicidad. No puedes usar Konfetti para promover productos, servicios u otras plataformas a menos que seas un socio o planificador de eventos aprobado. No está permitido enviar spam a los invitados con enlaces comerciales o promociones.
        </p>

        <h3 className="text-lg font-semibold mt-4 mb-2">Sustancias Controladas y Bienes Ilegales</h3>
        <p>
          No uses Konfetti para promover, distribuir o discutir sustancias o bienes ilegales. Esto incluye parafernalia de drogas, uso indebido de medicamentos recetados o cualquier actividad de venta o distribución ilegal.
        </p>

        <h3 className="text-lg font-semibold mt-4 mb-2">Terrorismo y Violencia</h3>
        <p>
        ...
        <h3 className="text-lg font-semibold mt-4 mb-2">Odio Basado en Identidad</h3>
        <p>
          Konfetti es un espacio inclusivo donde cada invitado debe sentirse bienvenido. Prohibimos el discurso de odio o la conducta dirigida a individuos o grupos basándose en:
        </p>
        <ul className="list-disc pl-5 space-y-1 mt-2">
          <li>Raza o etnia</li>
          ...
          <li>Religión o creencias</li>
        </ul>
        <p className="mt-2">
          Eliminaremos contenido o cuentas que promuevan o toleren el odio, la discriminación o la deshumanización.
        </p>

        <h3 className="text-lg font-semibold mt-4 mb-2">Perfiles No Auténticos</h3>
        <p>
          Konfetti es para invitados reales en eventos reales. No te hagas pasar por otros ni tergiverses quién eres. Esto incluye:
        </p>
        <ul className="list-disc pl-5 space-y-1 mt-2">
          <li>Usar nombres, fotos u ocupaciones falsas</li>
          <li>Crear cuentas múltiples o duplicadas</li>
          <li>Hacerte pasar por otro invitado, anfitrión o planificador</li>
          <li>Engañar a otros sobre tu estado de relación, género o ubicación</li>
        </ul>

        <h3 className="text-lg font-semibold mt-4 mb-2">Desinformación</h3>
        <p>
          No permitimos información falsa o engañosa que pueda dañar a otros, propagar pánico o interrumpir eventos.
        </p>
        <p className="mt-2">Esto incluye desinformación sobre:</p>
        <ul className="list-disc pl-5 space-y-1 mt-2">
          <li>Seguridad del evento</li>
          <li>Medidas de salud o seguridad pública</li>
          <li>Identidades o reputaciones de participantes</li>
          <li>Contenido conspirativo o difamatorio</li>
        </ul>

        <h3 className="text-lg font-semibold mt-4 mb-2">Violencia Física y Sexual</h3>
        <p>
        ...
        <ul className="list-disc pl-5 space-y-1 mt-2">
          ...
          <li>Acoso o acecho en o después de eventos</li>
          <li>Usar Konfetti para planificar o asistir en cualquier forma de explotación o tráfico de personas</li>
        </ul>

        <h3 className="text-lg font-semibold mt-4 mb-2">Estafas, Fraude y Robo</h3>
        <p>
        ...
        <ul className="list-disc pl-5 space-y-1 mt-2">
          <li>Hacerte pasar por anfitrión o planificador de bodas</li>
          <li>Pedir dinero o regalos bajo falsos pretextos</li>
          <li>Estafas de caridad falsa o recaudación de fondos</li>
        </ul>

        <h3 className="text-lg font-semibold mt-4 mb-2">Acoso Sexual</h3>
        <p>
          El consentimiento y el respeto no son negociables. El acoso sexual incluye cualquier comentario, imagen, gesto o avance sexual no deseado o no consensuado — tanto en línea como en eventos presenciales.
        </p>
        ...
        <ul className="list-disc pl-5 space-y-1 mt-2">
          ...
          <li>Objetificar o fetichizar a los invitados</li>
        ...
        <ul className="list-disc pl-5 space-y-1 mt-2">
          ...
          <li>Promover otras apps, enlaces o redes sociales repetidamente</li>
        ...
        <h3 className="text-lg font-semibold mt-4 mb-2">Suicidio, Autolesiones y Salud Mental</h3>
        <p>
          Nos importa profundamente el bienestar de nuestros invitados. Aunque está bien hablar sobre luchas emocionales respetuosamente, prohibimos contenido que promueva, glorifique o fomente la autolesión, los trastornos alimentarios o el suicidio.
        </p>
        <p className="mt-2">
          Si tú o alguien que conoces está luchando, por favor busca ayuda. Podemos conectarte con recursos de salud mental a solicitud.
        </p>

        <h3 className="text-lg font-semibold mt-4 mb-2">Contenido Violento o Gráfico</h3>
        <p>
        ...
        <h3 className="text-lg font-semibold mt-4 mb-2">Manipulación de la Plataforma</h3>
        <p>
          Para mantener Konfetti seguro y justo, prohibimos:
        </p>
        <ul className="list-disc pl-5 space-y-1 mt-2">
          <li>Comportamiento automatizado o con scripts (ej., bots o herramientas de extracción)</li>
          <li>Inflar artificialmente el engagement o las interacciones</li>
          <li>Eludir prohibiciones o restricciones usando VPNs o cuentas alternativas</li>
        </ul>
        <p className="mt-2">
          Las cuentas que se descubran participando en manipulación serán eliminadas permanentemente.
        </p>
      </div>

      <div>
        <h2 className="text-xl font-semibold mt-6 mb-3">Seguridad y Reportes</h2>
        <p>
          La seguridad es central para la experiencia de Konfetti. Usamos una combinación de detección automatizada, reportes de la comunidad y moderación humana para mantener la plataforma segura.
        </p>
        <p className="mt-2">
          Si el comportamiento de otro invitado te hace sentir inseguro, usa la función de Desemparejar o Reportar inmediatamente. Los reportes son confidenciales y son revisados por nuestro equipo de moderación.
        </p>
        <p className="mt-2">
          Los reportes falsos o el acoso a través de reportes también son violaciones de nuestras Directrices. Reportar a alguien únicamente por su identidad de género, apariencia u otras características protegidas no es aceptable.
        </p>
      </div>

      <div>
        <h2 className="text-xl font-semibold mt-6 mb-3">Filosofía de Aplicación</h2>
        <p>
        ...
        <ul className="list-disc pl-5 space-y-1 mt-2">
          ...
          <li>Notificar a anfitriones de eventos o, en casos graves, a las autoridades</li>
        </ul>
        <p className="mt-2">
          También podemos tomar medidas por conducta fuera de Konfetti si pone en peligro o daña a otros miembros — ya sea en un evento, a través de apps de mensajería o en otro lugar.
        </p>
        <p className="mt-2">
      ...
      <div>
        <h2 className="text-xl font-semibold mt-6 mb-3">Nuestro Compromiso</h2>
        <p>
          Konfetti existe para hacer las celebraciones de la vida real más significativas. Creemos en la amabilidad, la inclusividad y el consentimiento — y esperamos que todos en nuestra comunidad nos ayuden a mantener estos valores.
        </p>
        <p className="mt-2">
          Si tienes preguntas o comentarios sobre estas Directrices, contáctanos en hello@konfetti.app. Nuestro equipo siempre está aquí para ayudar.
        </p>
      </div>
    </div>
  );
