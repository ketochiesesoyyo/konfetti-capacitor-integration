  ...
  return (
    <div className="space-y-6 text-sm leading-relaxed">
      ...
      <div>
        ...
        <h3 className="text-lg font-semibold mt-4 mb-2">Suicidio, Autolesión y Salud Mental</h3>
        <p>
      ...
      <div>
        <h2 className="text-xl font-semibold mt-6 mb-3">Filosofía de Cumplimiento</h2>
        <p>
